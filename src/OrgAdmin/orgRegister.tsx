...
export default function RegisterOrganization() {
  ...
  useEffect(() => {
    let orgStr = localStorage.getItem("org");
    if (orgStr) {
  ...
  const handleSizeChange = (e: any) => {
    ...
    if (!isNaN(newSize) && newSize > 0) {
      ...
      setErrors({
        ...errors,
        sizeError: "Organization size should be more than zero.",
      });
    }
  };
        ...
        <div className="signup-form mt-8">
          ...
          <form onSubmit={handleSubmit} noValidate>
            <Box sx={{ mt: 1 }}>
              <div>
                <div className="file-input flex items-center ">
                  <div className="h-12 w-12 rounded-full overflow-hidden bg-gray-100">
                    ...
                    {file && file?.path && (
                      <div className="h-12 rounded-full overflow-hidden image-container">
                        <img
                          className="mw-100p"
              ...
              <InputLabel>
                Organization size <span className="astrick">*</span>
              </InputLabel>
              <TextField
                margin="normal"
                required
