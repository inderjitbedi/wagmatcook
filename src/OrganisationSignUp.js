                ...
                <Grid item xs={9}>
                    <div className='signup-form mt-8'>
                        ...
                        <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
                            ...
                            <TextField margin="normal" required fullWidth id="email" name="email" placeholder='name@mail.com'
                            ...
                            <TextField margin="normal" required fullWidth name="password" placeholder='Re-Enter Password'
                                type="password" id="password" />
