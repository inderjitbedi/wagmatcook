...
import PayRollAccountSideBar from "./PayRollAccountSideBar";
        ...
        <BodyContainer>
          {screenWidth < 600 ? (
            ...
            <SideBarContainer style={{ paddingTop: "3.5rem" }}>
              <PayRollAccountSideBar employeeId={employeeid} />
            </SideBarContainer>
          )}
          <div
            style={
...
export default PayRollAccountLayout;
