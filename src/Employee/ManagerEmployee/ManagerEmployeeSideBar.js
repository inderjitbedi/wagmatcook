  ...
  const location = useLocation();
     const SideBarData = [
       ...
       },
       {
         Title: "Job Details",
         to:
           "/manager-management/employee-details/job-details/" +
           props.employeeId,
       },
...

       {
         Title: "Certificates",
         to:
           "/manager-management/employee-details/certificates/" +
           props.employeeId,
       },
       {
         Title: "Disciplinary",
         to:
           "/manager-management/employee-details/discipline/" +
           props.employeeId,
       },
       {
         Title: "Performance",
         to:
           "/manager-management/employee-details/performance/" +
           props.employeeId,
       },
       {
         Title: "Documents",
         to:
           "/manager-management/employee-details/documents/" + props.employeeId,
       },
     ];
    const style = {
      textDecoration: "none",
