...
const shouldShowButton = (userType, isAccount) => {
  const allowedRoles = [ROLES.HR, ROLES.ORG_ADMIN, ROLES.PAYROLL];
  return allowedRoles.includes(userType) && !isAccount;
};
return (
  <>
    {isLoading ? (
      ...
      <>
        <LeaveDiv style={userType === ROLES.EMPLOYEE ? userstyle : {}}>
          Leave Adjustment
          {shouldShowButton(userType, isAccount) && (
                ...
                >
                  ...
                  <TableCell align="left" sx={Celllstyle2}>
                    <span
                      style={{
                        color:
                          data.nature !== "subtraction" ? "#0D7D0B" : "#EA4335",
                      }}
                    >
