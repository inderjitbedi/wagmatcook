  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      <SideBarList>
        ...
        <Link
          style={{ textDecoration: "none" }}
          to="/hr-management/leave/history"
        >
          <SideBarListContainer style={{ zIndex: "1" }}>
            <MdWorkHistory
              style={
        ...
        <Link style={{ textDecoration: "none" }} to="/hr-management/tasks">
          <SideBarListContainer style={{ zIndex: "1" }}>
            <BiTask
              style={
                location.pathname === "/hr-management/tasks"
                  ? style
                  : { color: "#5C5C5C" }
              }
            />
        ...
        <Link style={{ textDecoration: "none" }} to="/hr-management/documents">
          <SideBarListContainer style={{ zIndex: "1" }}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="19"
            ...
            >
              <path
                ...
                stroke={
                  location.pathname === "/hr-management/documents"
                    ? "#279AF1"
                    : "#5C5C5C"
                }
                stroke-width="1.5"
