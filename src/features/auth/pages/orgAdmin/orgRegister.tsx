                    ...
                    <div className='signup-form mt-8'>
                        ...
                        <form onSubmit={handleSubmit} noValidate>
                            <Box sx={{ mt: 1 }}>
                                    ...
                                    <div className="file-input flex items-center ">
                                        ...
                                        <div className="h-12 w-12 rounded-full overflow-hidden bg-gray-100">
                                            ...
                                            {file && file?.path && <div className="h-12 rounded-full overflow-hidden image-container">
                                                <img className="mw-100p" src={"http://hrapp.chantsit.com/api/" + file?.destination + "/" + file?.name} alt="" />
                                            </div>}
                                        </div>
                                ...
                                <InputLabel>Organization name <span className="astrick">*</span></InputLabel>
                                <TextField
                                    margin="normal"
                                    required
                                    fullWidth
