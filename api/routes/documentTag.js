...
router.get('/list', verifyToken([roles.ORG_ADMIN, roles.HR, roles.MANAGER, roles.EMPLOYEE,roles.PAYROLL]), documentTagController.list); // /list?page=1&limit=10&searchKey=search_keyword
