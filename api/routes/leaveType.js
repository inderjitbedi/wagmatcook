...
router.get('/list', verifyToken([roles.ORG_ADMIN, roles.HR, roles.MANAGER, roles.EMPLOYEE]), leaveTypeController.list); // /list?page=1&limit=10&searchKey=search_keyword
...
router.get('/employee-list/:employeeid', verifyToken([roles.SUPER_ADMIN, roles.ORG_ADMIN, roles.HR, roles.MANAGER, roles.EMPLOYEE]), leaveTypeController.employeeLeaveTypeList); // /list?page=1&limit=10&searchKey=search_keyword
