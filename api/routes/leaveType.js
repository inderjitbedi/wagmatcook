...
router.get('/employee-list/:employeeid', verifyToken([roles.ORG_ADMIN, roles.HR, roles.MANAGER, roles.EMPLOYEE]), leaveTypeController.employeeLeaveTypeList); // /list?page=1&limit=10&searchKey=search_keyword
