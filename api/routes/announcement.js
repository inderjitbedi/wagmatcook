...
router.post('/create', verifyToken([roles.ORG_ADMIN]), announcementController.create);
// router.put('/update/:id', verifyToken([roles.SUPER_ADMIN, roles.ORG_ADMIN]), announcementController.update);
router.put('/delete/:id', verifyToken([roles.ORG_ADMIN]), announcementController.delete);
