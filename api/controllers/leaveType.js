...
const leaveTypeController = {
  async create(req, res) {
    try {
      ...
      res
        .status(201)
        .json({ leaveType, message: "Leave type created successfully." });
    } catch (error) {
  ...
  async update(req, res) {
    try {
      ...
      res
        .status(200)
        .json({ leaveType, message: "Leave type updated successfully" });
    } catch (error) {
  ...
  async employeeLeaveTypeList(req, res) {
    try {
      ...
      const existingLeaveTypes = await EmployeeLeaveAllocation.find({
  ...
  async reorder(req, res) {
    try {
      ...
      res.status(200).json({
        ...
        currentPage: page,
        totalPages,
        message: "Leave types reordered successfully",
      });
    } catch (error) {
